...
# Liste des codes ou noms de pays (ISO3 ou noms FAO)
pays = None  # None pour tous les pays

# Liste des items (produits)
items = [21004, 21001, 21042, 210420, 22013, 220001, 21061]

# Choix du type de valeur (Valeur approchée : 6120, Estimation haute et basse : 6210)
elements = [6120]

# Liste des années sans prendre 2025 pour ne pas avoir de fausses données / mal insérées dans la base de données
